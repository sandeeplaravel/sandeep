...
Route::group([
	...
	Route::group(['middleware' => ['web', 'install.checker']], function ($router) {
		...
		Route::get('search-resume', 'ResumeController@resumeSearch');
		Route::post('search-resume', 'ResumeController@resumeSearchResult');
		Route::post('search-filter', 'ResumeController@resumeSearchFilter');
		//Added by Vimal
		...
		Route::group(['middleware' => ['guest', 'prevent.back.history']], function () {
			...
			//Added by Vimal
			Route::post('check-phone-exist', 'Auth\RegisterController@checkPhoneExist');
			Route::post('check-email-exist', 'Auth\RegisterController@checkEmailExist');
			//Added by Vimal
		...
		Route::get('verify/user/{field}/{token?}', 'Auth\RegisterController@verification')->name('verifyme');;
		...
		// Temp Resume Uploads
		Route::post("tempResume/store", 'TempResumeController@store');
		...
		Route::group(['middleware' => ['auth', 'banned.user', 'prevent.back.history'], 'namespace' => 'Account'], function ($router) {
			...
			// Education
			Route::get('account/education', 'EducationController@index');
			Route::get('account/education/create', 'EducationController@create');
			Route::post('account/education', 'EducationController@store');
			Route::get('account/education/{id}', 'EducationController@show');
			Route::get('account/education/{id}/edit', 'EducationController@edit');
			Route::put('account/education/{id}', 'EducationController@update');
			Route::get('account/education/{id}/delete', 'EducationController@destroy');
			Route::post('account/education/delete', 'EducationController@destroy');
			
			
			// Experience
			Route::get('account/experience', 'ExperienceController@index');
			Route::get('account/experience/create', 'ExperienceController@create');
			Route::post('account/experience', 'ExperienceController@store');
			Route::get('account/experience/{id}', 'ExperienceController@show');
			Route::get('account/experience/{id}/edit', 'ExperienceController@edit');
			Route::put('account/experience/{id}', 'ExperienceController@update');
			Route::get('account/experience/{id}/delete', 'ExperienceController@destroy');
			Route::post('account/experience/delete', 'ExperienceController@destroy');
			
			
			// Skills
			Route::get('account/skills', 'SkillsController@index');
			Route::get('account/skills/create', 'SkillsController@create');
			Route::post('account/skills', 'SkillsController@store');
			Route::get('account/skills/{id}', 'SkillsController@show');
			Route::get('account/skills/{id}/edit', 'SkillsController@edit');
			Route::put('account/skills/{id}', 'SkillsController@update');
			Route::get('account/skills/{id}/delete', 'SkillsController@destroy');
			Route::post('account/skills/delete', 'SkillsController@destroy');
