...
<head>
	...
	<script async src="https://www.googletagmanager.com/gtag/js?id=UA-37395089-2"></script>
	<script>
		window.dataLayer = window.dataLayer || [];
		function gtag(){dataLayer.push(arguments);}
		gtag('js', new Date());

		gtag('config', 'UA-37395089-2');
	</script>
	<meta name="google-site-verification" content="PCJkv3tc6_9nxVb114_el7O5jlkvdgOwACgxG0PkLcI" />
	...
	<script>
		...
		fbq('init', '539874723084509');
		fbq('track', 'PageView');
	</script>
	<noscript>
	    <img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=539874723084509&ev=PageView&noscript=1" />
	</noscript>
...
<!-- Added by Vimal -->
<script src="{{ url('/assets/bootbox/bootbox.all.js') }}"></script>
<!-- Added by Vimal -->
