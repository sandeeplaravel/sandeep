		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-9 page-content">
					...
					<div class="inner-box">
						<h2 class="title-2"><i class="icon-town-hall"></i> {{ t('Edit the Skills') }} </h2>
						
						<div class="mb30" style="float: right; padding-right: 5px;">
							<a href="{{ lurl('account/skills') }}">{{ t('My Skills') }}</a>
						</div>
						...
						<div id="accordion" class="panel-group">
							...
							<div class="card card-default">
								<div class="card-header">
									<h4 class="card-title"><a href="#skillsPanel" data-toggle="collapse" data-parent="#accordion"> {{ t('Skills Information') }} </a></h4>
								</div>
								<div class="panel-collapse collapse show" id="companyPanel">
									<div class="card-body">
										<form name="skills" class="form-horizontal" role="form" method="POST" action="{{ lurl('account/skills/' . $skills->id) }}" enctype="multipart/form-data">
											{!! csrf_field() !!}
											<input name="_method" type="hidden" value="PUT">
											<input name="panel" type="hidden" value="skillsPanel">
											<input name="skills_id" type="hidden" value="{{ $skills->id }}">
											
											@include('account.skills._form')
