			...
			<div class="row">
				...
				<div class="col-md-9 page-content">
					<div class="inner-box">
						...
						<div class="mb30">
							<a href="{{ lurl('account/resumes/create') }}" class="btn btn-default" style="background: linear-gradient(to bottom, #ffeb43 0, #fcde11 100%);"><i class="icon-plus"></i> {{ t('Add a new resume') }}</a>
						</div>
						<br>
