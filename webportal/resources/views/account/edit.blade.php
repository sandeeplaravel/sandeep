                                            ...
                                            @else
                                                ...
                                                */
                                                ...
                                                <div class="form-group row required">
                                                  ...
                                                  <!-- email -->
												<?php $current_ctcError = (isset($errors) and $errors->has('current_ctc')) ? ' is-invalid' : ''; ?>
                                                <div class="form-group row required">
                                                    <label class="col-md-3 col-form-label">{{ t('Current CTC in Lakh') }} <sup>*</sup></label>
													<div class="input-group col-md-9">
														<input id="current_ctc"
															   name="current_ctc"
															   type="text"
															   class="form-control{{ $current_ctcError }}"
															   placeholder="{{ t('Current CTC in Lakh') }}"
                                            	...
                                            	<?php $expected_ctcError = (isset($errors) and $errors->has('expected_ctc')) ? ' is-invalid' : ''; ?>
                                                <div class="form-group row required">
                                                    <label class="col-md-3 col-form-label">{{ t('Expected CTC') }} <sup>*</sup></label>
													<div class="input-group col-md-9">
													
														<select id="expected_ctc" name="expected_ctc" class="form-control sselecter{{ $expected_ctcError }}">
					<option value="0" {{ (!old('skills.expected_ctc') or old('skills.expected_ctc')==0) ? 'selected="selected"' : '' }}> Select Expected CTC % </option>
		                                               <?php for($i=1;$i<=300;$i++) {?>
														<option value="{{ $i }}"
								{{ (!old('skills.expected_ctc') or old('skills.expected_ctc')==$i ) ? 'selected="selected"' : '' }}>
							{{ $i }}%
						</option>
								...
								<?php } ?>
                                            ...
                                            <?php $prefered_locationError = (isset($errors) and $errors->has('prefered_location')) ? ' is-invalid' : ''; ?>
                                                <div class="form-group row required">
                                                    <label class="col-md-3 col-form-label">{{ t('Prefered Location') }} <sup>*</sup></label>
													<div class="input-group col-md-9">
														...
														<input id="prefered_location"
															   ...
															   value="{{ old('prefered_location', $user->prefered_location) }}"
														>
													</div>
                                                </div>
                                            @endif
