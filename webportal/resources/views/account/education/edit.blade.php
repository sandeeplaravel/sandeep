		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-9 page-content">
					...
					<div class="inner-box">
						<h2 class="title-2"><i class="icon-town-hall"></i> {{ t('Edit the Education') }} </h2>
						...
						<div id="accordion" class="panel-group">
							...
							<div class="card card-default">
								...
								<div class="panel-collapse collapse show" id="companyPanel">
									<div class="card-body">
										<form name="education" class="form-horizontal" role="form" method="POST" action="{{ lurl('account/education/' . $education->id) }}" enctype="multipart/form-data">
											{!! csrf_field() !!}
