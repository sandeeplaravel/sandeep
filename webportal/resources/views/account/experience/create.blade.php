		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-9 page-content">
					...
					<div class="inner-box">
						<h2 class="title-2"><i class="icon-town-hall"></i> {{ t('Create a new experience') }} </h2>
						...
						<div class="panel-group" id="accordion">
							...
							<div class="card card-default">
								...
								<div class="panel-collapse collapse show" id="experiencePanel">
									<div class="card-body">
										<form name="experience" class="form-horizontal" role="form" method="POST" action="{{ lurl('account/experience') }}" enctype="multipart/form-data">
											{!! csrf_field() !!}
